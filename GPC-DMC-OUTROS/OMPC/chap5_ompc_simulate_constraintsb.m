...
function [J,x,y,u,c,Ksompc,F,t,M1] = chap5_ompc_simulate_constraintsb(A,B,C,D,nc,Q,R,Q2,R2,x0,runtime,umin,umax,Kxmax,xmax,rdmax,rdmin)
...
[cfut,vv,exitflag] = quadprog(SC,SXC'*xhat(:,i),N,t-M*xhat(:,i),[],[],[],[],[],opt);
