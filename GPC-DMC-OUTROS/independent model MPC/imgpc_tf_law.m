...
%%%%                     y = H*Du(future) + P*Du(past) + Q*y(past)+L*offset   
%%%%            (iii) weights on cost are Wy (outputs), Wu (inputs)
%%%%            (iv)  sizey is the number of outputs
%%%%
%%%%   Performance index is given as 
%%%%     J = Du(future)' S Du(future) + Du(future)'*2X*[Du(past);y(past);r;offset]
%%%%   
%%%%   Control law is given as 
%%%%          Du(future) = Pr*r - Dk*Du(past) - Nk*y(past) - Mk*offset
%%%%
%%%% Pr is given as a simple gain (edit this code to reinstitute advance knowledge)
%%%% Prlong gives full Pr
%%%%
%%%%            [Nk,Dk,Pr,Mk,S,X,Prlong] =mpc_law(H,P,Q,L,nu,Wu,Wy,sizey)
%%  
%% Author: J.A. Rossiter  (email: J.A.Rossiter@shef.ac.uk)

function  [Nk,Dk,Pr,Mk,S,X,Prlong] =imgpc_tf_law(H,P,Q,LL,nu,Wu,Wy,sizey)
...
Pr = Prlong*L;
X = [P1'*WY*P,P1'*WY*Q,-P1'*WY*L,P1'*WY*L];
