...
%%%  Enforces constraints but these are not included in optimisation
%%%
%%%%%  [y,u,Du,r] = mpc_simulate_noconstrainthandling(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ref,dist,noise)
...
function [y,u,Du,r] = mpc_simulate_noconstrainthandling(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ref,dist,noise)
