...
lambda=1;
ny2=20;
ref = [zeros(1,ny-1),ones(1,ny2-ny+1)];
...
figure(1); clf reset
v=0:ny;v2=0:ny2;
aa=plot(v2,[0;yfut2],'b',[0 ny-14 ny-14 ny2],[0 0 1 1],'r--',...
    [nu-1,nu-1],[-0.4,1.5],'g:',[0:nu-1,ny2],[uopt;uopt(end)],'m');
set(aa,'linewidth',2);
c=legend('Output','set point','n_u','input');
set(c,'fontsize',18)
